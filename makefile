...
graphicus-02: graphicus-02.o tests.o canevas.o couche.o forme.o rectangle.o cercle.o
	g++ -o graphicus-02 graphicus-02.o tests.o canevas.o couche.o forme.o rectangle.o cercle.o
